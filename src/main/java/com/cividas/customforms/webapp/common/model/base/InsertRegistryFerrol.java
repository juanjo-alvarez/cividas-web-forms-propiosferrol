...
@XmlRootElement
public class InsertRegistryFerrol implements Serializable, IRegistryData {
    ...
    @XmlElement
    protected RegistryInterestedFerrol[] interesteddata;
    ...
    public RegistryInterestedFerrol[] getInteresteddata() {
        return interesteddata;
    }

    public void setInteresteddata(RegistryInterestedFerrol[] interesteddata) {
