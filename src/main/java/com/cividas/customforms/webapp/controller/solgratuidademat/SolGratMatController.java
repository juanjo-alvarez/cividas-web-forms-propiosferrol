...
public class SolGratMatController extends BaseControllerUvigo {
	...
	protected void loadDataMasters() {
		...
		try {	
			...
			log.error("Se ha producido un error al cargar el maestro de Universidades de Galicia. A continuación se mostrará la traza del error",cqe);
		}
		...
		try {
			...
			log.error("Se ha producido un error al cargar el maestro de Parentescos de Gratuidade. A continuación se mostrará la traza del error",cqe);
		}
...
// LOR No queremos impedir múltiples registros
