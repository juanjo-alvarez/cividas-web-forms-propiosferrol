...
@ManagedBean(name = "onlyOneRegistryPersonalErrorController")
@ViewScoped
public class OnlyOneRegistryPersonalErrorController extends BaseControllerUvigo {

    private static final long serialVersionUID = -1186030891593778444L;
