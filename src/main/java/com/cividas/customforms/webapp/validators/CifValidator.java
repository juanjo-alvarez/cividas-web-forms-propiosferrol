...
@FacesValidator("com.cividas.customforms.webapp.validators.cifValidator")
...
//			}
  			...
  			if(!NIFDocument.isNIFWellFormed(value.toString()) ) {			
				throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR,getResourceMessage(label.toString())+" "+ getResourceMessage("notdnivalid"), getResourceMessage(label.toString())+" "+ getResourceMessage("notdnivalid")));
			}              
